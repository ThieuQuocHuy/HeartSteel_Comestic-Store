...
namespace Presentation.Pages.Admin
{
    public partial class ReportsPage : Form
    {
        ...
        {
            MessageBox.Show("📊 Chức năng quản lý kho hàng sẽ được phát triển trong phiên bản tiếp theo.", 
                "Quản lý kho hàng", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
